...
ค่ามาตรฐาน: ข้อความล่าสุด **3** • ตัด/ข้อความ **1200** • เพดานรวม **10000**
(ตั้ง "ข้อความล่าสุด" เป็น 1 ไม่มีประโยชน์ เพราะจะส่งข้อความเดียวกันซ้ำสองรอบทั้งใน `{{chat}}` และ `{{lastMessage}}` — ใช้ 0 หรือ 2-4 แทน)
